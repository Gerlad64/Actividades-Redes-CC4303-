...
**IMPORTANTE**
Por algún motivo, luego de uno o dos peticiones al proxy, este se bloquea,
por lo que se debe reiniciar para seguir con las pruebas.

#### Pruebas
- `curl cc4304.bachmann.cl -x IP_Proxy:Port` muestra que envía y usando el header `X-ElQuePregunta` con el usuario configurado en `proxy.json`
